...
from yopo.datasets import get_loading_pipeline
from yopo.evaluation import eval_map
from yopo.registry import DATASETS, RUNNERS
from yopo.structures import DetDataSample
from yopo.utils import replace_cfg_vals, update_data_root
...
def main():
    ...
    init_default_scope(cfg.get('default_scope', 'yopo'))
