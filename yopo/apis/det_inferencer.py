...
from yopo.evaluation import INSTANCE_OFFSET
from yopo.registry import DATASETS
from yopo.structures import DetDataSample
from yopo.structures.mask import encode_mask_results, mask2bbox
from yopo.utils import ConfigType
...
class DetInferencer(BaseInferencer):
    ...
    Args:
        ...
        scope (str, optional): The scope of the model. Defaults to yopo.
    ...
    def _load_weights_to_model(self, model: nn.Module,
        ...
        if checkpoint is not None:
            ...
            if 'dataset_meta' in checkpoint_meta:
                # yopo 3.x, all keys should be lowercase
                model.dataset_meta = {
                    k.lower(): v
    ...
    def _init_pipeline(self, cfg: ConfigType) -> Compose:
        ...
        pipeline_cfg[load_img_idx]['type'] = 'yopo.InferencerLoader'
