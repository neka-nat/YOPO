...
def init_detector(
    ...
    scope = config.get('default_scope', 'yopo')
    if scope is not None:
        init_default_scope(config.get('default_scope', 'yopo'))
...
def inference_detector(
    ...
    if test_pipeline is None:
        ...
        if isinstance(imgs[0], np.ndarray):
            ...
            # in module unregistered error if not prefixed with yopo.
            test_pipeline[0].type = 'yopo.LoadImageFromNDArray'
