...
from yopo.models import (DETR, ChannelMapper, DetDataPreprocessor, DETRHead,
                          ResNet)
...
from yopo.models.task_modules import (BBoxL1Cost, ClassificationCost,
...
# from the default setting in yopo.
train_pipeline = [
