...
from yopo.structures import DetDataSample, ReIDDataSample, TrackDataSample
from yopo.structures.bbox import BaseBoxes
...
@TRANSFORMS.register_module()
class Pack6DPoseInputs(BaseTransform):
    INSTANCEDATA_6D_POSE_KEYS = [
        'T', 'rotations', 'centers_2d', 'z'
    ]
    mapping_table = {
        'gt_bboxes': 'bboxes',
        'gt_bboxes_labels': 'labels',
...
@TRANSFORMS.register_module()
class Pack9DPoseInputs(Pack6DPoseInputs):
    INSTANCEDATA_6D_POSE_KEYS = [
        'T', 'rotations', 'scales', 'translations', 'centers_2d',
        'z', 'gt_handle_visibility'
    ]
    mapping_table = {
        'gt_bboxes': 'bboxes',
        'gt_bboxes_labels': 'labels',
