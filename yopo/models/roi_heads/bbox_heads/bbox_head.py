...
from yopo.models.layers import multiclass_nms
from yopo.models.losses import accuracy
from yopo.models.task_modules.samplers import SamplingResult
from yopo.models.utils import empty_instances, multi_apply
from yopo.registry import MODELS, TASK_UTILS
from yopo.structures.bbox import get_box_tensor, scale_boxes
from yopo.utils import ConfigType, InstanceList, OptMultiConfig
...
class BBoxHead(BaseModule):
    ...
    def refine_bboxes(self, sampling_results: Union[List[SamplingResult],
        ...
        Example:
            ...
            >>> import numpy as np
            >>> from yopo.models.task_modules.samplers.
