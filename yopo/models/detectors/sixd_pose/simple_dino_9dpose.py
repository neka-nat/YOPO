...
class SimpleDINO9DPose(DeformablePoseDETR):
    ...
    def pre_decoder(
        ...
        # --- newly added ---
        enc_outputs_translation = self.bbox_head.reg_translation_branch[
        ...
        # --- newly added ---
        topk_translation = torch.gather(
            enc_outputs_translation, 1,
            topk_indices.unsqueeze(-1).repeat(1, 1, 3))
        topk_rotation = torch.gather(
            enc_outputs_rotation, 1,
            topk_indices.unsqueeze(-1).repeat(1, 1, 6))
        ...
        head_inputs_dict = dict(
            ...
            enc_outputs_translation=topk_translation,
