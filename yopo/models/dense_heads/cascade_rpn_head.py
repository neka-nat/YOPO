...
from yopo.utils import (ConfigType, InstanceList, MultiConfig,
    ...
    def _predict_by_feat_single(self,
        ...
        for idx in range(len(cls_scores)):
            ...
            if self.use_sigmoid_cls:
                ...
                # num_class in RPN head since yopo v2.5, which is unified to
                # be consistent with other head since yopo v2.0. In yopo v2.0
