...
from yopo.structures.bbox import (cat_boxes, empty_box_as, get_box_tensor,
                                   get_box_wh, scale_boxes)
from yopo.utils import InstanceList, MultiConfig, OptInstanceList
    ...
    def _predict_by_feat_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, priors) in \
            ...
            if self.use_sigmoid_cls:
                ...
                # remind that we set FG labels to [0] since yopo v2.0
                # BG cat_id: 1
