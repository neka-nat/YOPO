...
from yopo.structures.bbox import BaseBoxes, cat_boxes
from yopo.utils import util_mixins
from yopo.utils.util_random import ensure_rng
...
class SamplingResult(util_mixins.NiceRepr):
    ...
    Example:
        ...
        >>> from yopo.models.task_modules.samplers.sampling_result import *  # NOQA
    ...
    def random(cls, rng=None, **kwargs):
        ...
        from yopo.models.task_modules.assigners import AssignResult
        from yopo.models.task_modules.samplers import RandomSampler
        rng = ensure_rng(rng)
