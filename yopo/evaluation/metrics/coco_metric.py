...
from yopo.datasets.api_wrappers import COCO, COCOeval, COCOevalMP
from yopo.registry import METRICS
from yopo.structures.mask import encode_mask_results
...
class CocoMetric(BaseMetric):
    ...
    def gt_to_coco_json(self, gt_dicts: Sequence[dict],
        ...
        info = dict(
            ...
            description='Coco json file converted by yopo CocoMetric.')
        coco_json = dict(
            info=info,
            images=image_infos,
